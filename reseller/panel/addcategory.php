...
if($save_check=="true"){
	...
	if(empty($error_check)){
		$result = db_query("SELECT `title` FROM `db_category` WHERE `title`='$title'" , "select");
		if(mysqli_num_rows($result)==0){
			
			if(db_query("INSERT INTO `db_category` (`title`, `english`, `status`) VALUES ('$title', '$english', '$status');","insert")){
				adminlog("Add Category | Title=$title");
...
<body><center>
	...
	<div class="father_div">
        ...
        <div class="bodydiv fl">        
            ...
            <div class="bodydiv_item_title fr"><div><img src="images/icon6.png" />اضافه کردن دسته بندی</div></div>
            ...
            <div class="bodydiv_item_body fr" id="bodydiv_item_body">            
                ...
                <div class="addcategory_div fr">                     
                    <form id="form_ajax" method="post" action="addcategory.php?sess=<?php echo $page_sess; ?>&save=true" >
                    	<br style="clear:both" />
                        ...
                        <p>نام دسته بندی : </p><input type="text" name="english" id="english" dir="ltr" style="margin-right:30px;" /><p style="color:#ccc;">انگلیسی</p><br style="clear:both" /> 
