...
Sub Initialize
	...
	Merchand_ID =  "29882ae2-3c64-11ea-a2b4-000c295eb8fc"                                        '** Write your Merchant ID (if you don't have , you can make Account in Zarinpal.com)
	...
	Start_HostName_With =  "https://mazraeyeman.ir/reseller/api_files/zarinpal"                               '** the end of HastName without / it's very importent***
	Font= SaeloZahra.font    '** For a more beautiful view
...
'	StatusBar.StatusBarColor = Colors.RGB(255,220,8)
	SaeloZahra.SetStatusBarColor(Colors.RGB(255,220,8))
...
private Sub Activity_KeyPress (KeyCode As Int) As Boolean
	...
	Select KeyCode
		Case KeyCodes.KEYCODE_BACK
			Dim a As Int
			a=Msgbox2Async("آیا می خواهید از صفحه پرداخت خارج شوید؟"&CRLF&"خروج شما باعث لغو پرداخت می شود؟","خارج شدن از پرداخت","خارج می شوم","به پرداخت ادامه می دهم","",Null,False)
