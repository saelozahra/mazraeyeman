...
public class otpconfirmact implements IRemote{
	public static otpconfirmact mostCurrent;
	public static RemoteObject processBA;
    public static boolean processGlobalsRun;
    public static RemoteObject myClass;
    public static RemoteObject remoteMe;
	public otpconfirmact() {
		mostCurrent = this;
	}
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("otpconfirmact"), "ir.saelozahra.damaara.mazraeyeman.otpconfirmact");
	}
...
public boolean isSingleton() {
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
		...
		pcBA = new PCBA(this, otpconfirmact.class);
...
public static RemoteObject _cd = RemoteObject.declareNull("anywheresoftware.b4a.objects.drawable.ColorDrawable");
...
public static RemoteObject _timerlbl = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
