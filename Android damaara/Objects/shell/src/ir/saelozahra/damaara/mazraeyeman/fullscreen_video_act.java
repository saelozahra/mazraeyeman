...
public class fullscreen_video_act implements IRemote{
	public static fullscreen_video_act mostCurrent;
	public static RemoteObject processBA;
    public static boolean processGlobalsRun;
    public static RemoteObject myClass;
    public static RemoteObject remoteMe;
	public fullscreen_video_act() {
		mostCurrent = this;
	}
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("fullscreen_video_act"), "ir.saelozahra.damaara.mazraeyeman.fullscreen_video_act");
	}
