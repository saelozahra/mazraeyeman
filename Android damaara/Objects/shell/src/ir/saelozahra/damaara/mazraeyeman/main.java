...
public class main implements IRemote{
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("main"), "ir.saelozahra.damaara.mazraeyeman.main");
	}
...
public static RemoteObject _newversion = RemoteObject.createImmutable(false);
...
public static RemoteObject _timerint = RemoteObject.createImmutable(0);
...
public static RemoteObject _logoiv = RemoteObject.declareNull("anywheresoftware.b4a.objects.ImageViewWrapper");
