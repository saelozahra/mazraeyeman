...
Sub Activity_Create(FirstTime As Boolean)
	...
	jobs(0).Initialize("jobs_rate",Me)
	jobs(1).Initialize("jobs_price",Me)
	jobs(2).Initialize("jobs_near",Me)
	jobs(3).Initialize("jobs_darmanzel",Me)
	
	jobs(0).Download(saelozahra.site_url&"/user/index/json/2/"&File.ReadString(saelozahra.dir,"lat")&"/"&File.ReadString(saelozahra.dir,"lng")&"/rate")
	jobs(1).Download(saelozahra.site_url&"/user/index/json/2/"&File.ReadString(saelozahra.dir,"lat")&"/"&File.ReadString(saelozahra.dir,"lng")&"/price")
	jobs(2).Download(saelozahra.site_url&"/user/index/json/2/"&File.ReadString(saelozahra.dir,"lat")&"/"&File.ReadString(saelozahra.dir,"lng")&"/near")
	jobs(3).Download(saelozahra.site_url&"/user/index/json/2/"&File.ReadString(saelozahra.dir,"lat")&"/"&File.ReadString(saelozahra.dir,"lng")&"/darmanzel")
...
'		ToastMessageShow("Error: " & Job.ErrorMessage, True)
		If SaeloZahra.checkinternet Then Log("Error: " & Job.ErrorMessage)
