...
Sub Activity_Create(FirstTime As Boolean)
	...
	header_lbl.Text="ثبت محصول جدید"
	...
	zamane_kesht_et.Background=SaeloZahra.CD(SaeloZahra.colorLight)
...
'	pdpd.Initialize("pdpd",1400,1300,SaeloZahra.font,SaeloZahra.colorLight,"ثبت","لغو","امروز")
	...
	pdpd.Initialize("pdpd",1400,1395,SaeloZahra.font,SaeloZahra.colorDark,"ثبت","بازگشت","امروز")
	
	If GetDeviceLayoutValues.Width > 500 Then
		header_lbl.Left = header_lbl.Left -18dip
		ScrollView1.Top=ScrollView1.Top+24dip
		ScrollView1.Height=ScrollView1.Height-24dip
	End If
...
'			Case "fieldhayeDarkhastiJob" ' نمایش لیست فیلد های انتخابی کاربر
'				If Job.GetString <> "{""fieldhayeDarkhastiJob"":[]}" And Job.GetString <> "" Then
'					
'					Dim parser As JSONParser
'					parser.Initialize(Job.GetString)
'					Dim root1 As Map = parser.NextObject
'					Dim showField1 As List = root1.Get("showfield")
'					
'					checkBoxTop = 50dip
'					PanelMavaredeDarkhasti.RemoveAllViews
'					
'					For Each colshowfield As Map In showField1
'						Dim Fa_Title As String = colshowfield.Get("Fa_Title")
'						Dim FieldID As Int = colshowfield.Get("ID")
'						Dim chkb As CheckBox
'						chkb.Initialize("chkb")
'						chkb.Text=Fa_Title
'						chkb.Typeface=SaeloZahra.font
'						chkb.Tag=FieldID
'						PanelMavaredeDarkhasti.AddView(chkb,18dip,checkBoxTop+40dip,PanelMavaredeDarkhasti.Width-36dip,-2)
'						checkBoxTop = checkBoxTop+40dip
'					Next
'					
'					PanelMavaredeDarkhasti.Height = checkBoxTop + 80dip
'					save_btn.Top = PanelMavaredeDarkhasti.Top + PanelMavaredeDarkhasti.Height + 24dip
'					ScrollView1.Panel.Height = save_btn.Top + save_btn.Height + 24dip
'					
'					Dim LabelDarkhasti As Label
'					LabelDarkhasti.Initialize("LabelDarkhasti")
'					LabelDarkhasti.Text = "مــوارد درخــواستی"
'					LabelDarkhasti.textcolor = 0xFF828282
'					LabelDarkhasti.Top = PanelMavaredeDarkhasti.Top +18dip
'					LabelDarkhasti.Gravity=Bit.Or(Gravity.CENTER_HORIZONTAL,Gravity.CENTER_VERTICAL)
'					LabelDarkhasti.Typeface=SaeloZahra.font
'					PanelMavaredeDarkhasti.AddView(LabelDarkhasti,0,18dip,PanelMavaredeDarkhasti.Width-16dip,-2)
'				End If
