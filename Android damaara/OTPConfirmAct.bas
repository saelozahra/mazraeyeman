...
'	Main.amaroid.TrackView(ActionBar.title)
	...
	login_btn.Color = SaeloZahra.Color
...
Sub login_btn_Click
'	If RegisterAct.Operator=="hamrah" Then
'		job1.Initialize("job1",Me)
'		job1.Download("http://server.mazraeyeman.ir:3400/telepormo/OTP_Confirmation.php?tel="&SaeloZahra.Replace0With98(File.ReadString(SaeloZahra.dir,"usrnm"))&"&msg="&username_et.Text&"&referencecode="&RegisterAct.referenceCode&"&otptransaction="&RegisterAct.OTPTransactionId)
'		ProgressDialogShow(SaeloZahra.CSB("در حال بررسی..."))
'	Else
		If RegisterAct.OTPCode == username_et.Text Then
...
Sub FinishVAS
	Activity.Finish
	CallSubDelayed(RegisterAct,"SubmitForm")
